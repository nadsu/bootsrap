...
<body>
    ...
    <div class="card">
        <div class="card-header">
            Contoh Valisasi Form dengan PHP 
        </div>
        <div class="card-body">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" name="web" class="form-control <?php echo($error_email !="" ? "is-invalid" : ""); ?>" id="web"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" name="telp" class="form-control <?php echo($error_email !="" ? "is-invalid" : ""); ?>" id="telp"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <textarea name="pesan" class="form-control <?php echo($error_email !="" ? "is-invalid" : ""); ?>" ><?php echo $pesan; ?></textarea><span class="warning"><?php echo $error_pesan; ?></span>
        </div>
    </div>
